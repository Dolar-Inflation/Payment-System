...
public class AccountController {
    ...
    public AccountController(AccountRepository accountRepository, CustomUserDetailsService customUserDetailsService, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager) {
